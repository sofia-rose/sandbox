...
static void CalcResultU64(void)
{
  int8_t a = 12, e = 101;
  int16_t b = 17, f = 37;
  int32_t c = 71000000, g = 25;
  int64_t d = 90000000000, h = 5;

  uint64_t quo1, rem1;
  uint64_t quo2, rem2;

  // Calculate quotient and remainder for (a + b + c + d) / (e + f + g + h)
  quo1 = ((uint64_t)a + b + c + d) / ((int64_t)e + f + g + h);
  rem1 = ((uint64_t)a + b + c + d) % ((int64_t)e + f + g + h);
