...
test "basic slices" {
  ...
  // to perform some optimisations like recognizing a comptime-knwn length when
  ...
  // uncomment and test will panic with index out of bounds error
  // slice[10] += 1;
  ...
  // This is because the pointer-to data is zero bits long, so its immutability is irrelevant.
}
